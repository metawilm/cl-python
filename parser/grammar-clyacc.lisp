...
;; Making CLPython portable is a goal. Supporting CL-Yacc in addition to Allegro's YACC
;; is a step towards that.
;; But I can't get the CL-Yacc parser to run function CLYACC-TEST (below) successfully.
;; Probably the grammar rules given as input are wrong, or perhaps the states and goto's
;; generated by CL-Yacc are incorrect. -WB
...
(defmacro define-clyacc-python-parser ()
  `(yacc:define-parser *python-parser*
       ...
       (:start-symbol clpython.parser::print-stmt) ;; for testing
